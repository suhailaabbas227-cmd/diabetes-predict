...
plt.tight_layout()
plt.savefig("figures/eda_class_distribution.png", dpi=120)
plt.close()
...
plt.tight_layout()
plt.savefig("figures/eda_correlation_heatmap.png", dpi=120)
plt.close()
...
plt.tight_layout()
plt.savefig("figures/eda_feature_importance.png", dpi=120)
plt.close()
...
plt.tight_layout()
plt.savefig("figures/eda_pca_scatter.png", dpi=120)
plt.close()
...
print("  Figures saved:")
print("   - figures/eda_class_distribution.png")
print("   - figures/eda_correlation_heatmap.png")
print("   - figures/eda_feature_importance.png")
print("   - figures/eda_pca_scatter.png")
print("=" * 55)
